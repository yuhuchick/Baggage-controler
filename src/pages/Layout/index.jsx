...
const items = [
  ...
  getItem('报警管理', '', <DesktopOutlined />,[
    getItem('报警数据','/second'),
    getItem('报警设置','/second/set')
  ]),
  getItem('摄像头管理', '/third', <UserOutlined />),
  getItem('边缘计算设备管理', '/forth', <TeamOutlined />),
  getItem('算法管理', '/fifth', <FileOutlined />),
  getItem('添加布控', '/sixth', <FileOutlined />),
];
...
export default function Home(){
    ...
    const getName = (pathname)=>{
      ...
      else if(pathname === '/second/set'){
        return '报警管理  /  报警设置'
      }
      else if(pathname === '/third'){
        return '摄像头管理'
      }
      else if(pathname === '/forth'){
        return '边缘计算设备管理'
      }
      else if(pathname === '/fifth'){
        return '算法管理'
      }
